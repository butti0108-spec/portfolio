(() => {
  ...
  const SKILL_POPUPS = {
    design: {
      title: "Webデザイン",
      body:
        "見た目の飾りから入らず、先に「誰が・何を・どの順で読むか」を決めます。優先順位と余白を先に固め、色や装飾は後から足す順番です。迷わない画面を、引き算で整えます。"
    },
    code: {
      title: "コーディング",
      body:
        "骨組み・見た目・動きを分けて作るので、直す場所がはっきりします。見た目だけ・動きだけ、と部分で直せる形にして、あとからの変更に強くします。"
    },
    ai: {
      title: "AI活用",
      body:
        "下書き・整理・試し置きなど、下準備に使います。そのまま公開せず、人の目で言葉・見た目・動線を整えてから出す、という使い方です。"
    },
    wordpress: {
      title: "WordPress",
      body:
        "ログインして、決まった場所の文章と写真だけ差し替えられる形にします。毎回ゼロから作り直さず、自分で更新できる土台として使います。",
      link: { href: "#offer", label: "ご依頼できることを見る" }
    }
  };
